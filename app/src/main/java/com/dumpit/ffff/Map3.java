...
public class Map3 extends Fragment implements OnMapReadyCallback, GoogleMap.OnInfoWindowClickListener{
    MapView sView = null;
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        for (int x = 0; x < latitude.length; x++) {
            ...
            BitmapDrawable bitmapdraw=(BitmapDrawable)getResources().getDrawable(R.drawable.bat);
